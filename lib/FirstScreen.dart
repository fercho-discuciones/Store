// ignore_for_file: file_names, unnecessary_string_interpolations, unused_local_variable, prefer_const_constructors, unused_import, use_key_in_widget_constructors, unused_label, deprecated_member_use
...
class FirstScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(title: Text("Wuamart")),
        ...
        child: Column(
          children: [
            myListTile(index),
            //Image.asset("assets/images/gato.jpg", scale: 1.0),
            Row(mainAxisAlignment: MainAxisAlignment.end, children: [
              RaisedButton(
                child: Text("Aceptar"),
                onPressed: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) => SecondScreen(inde: index)));
                },
                ),
            ]),
          ],
